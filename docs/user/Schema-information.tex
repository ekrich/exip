...
\begin{itemize}
\item \textbf{Use Schema: None} (schema-less mode)
\item \textbf{Preserve Namespace Declarations} (enables Preserve.prefixes)
\item \textbf{Include options} (recommended - embeds options in EXI header)
\end{itemize}

If you leave ``Include options'' unchecked, you need to use the \texttt{-ops=0001000} argument
