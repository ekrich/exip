...
provides a Microsoft Visual Studio 2022 build under \texttt{build/vs2022/} and \emph{GCC} toolchain builds under \texttt{build/gcc/}.
The \texttt{build/gcc/} folder further contains platform-dependent parameters and
headers located in subfolders - \texttt{build/gcc/contiki} for the Contiki-ng sensor platform OS and
...
platform to Contiki-ng for example, add \texttt{TARGET=zoul} as an argument of \texttt{make}
